...
async function searchOntsSms() {
    ...
    const ontsRequest = await fetch('https://commands.nmultifibra.com.br/maintenance/sms/search_onts', requestOptions)
    ...
    if (responsOfontsRequest.error == true) {
        ...
        return window.location = `https://commands.nmultifibra.com.br/maintenance/sms/render_error_page?message=${messageError}`
    }

    return window.location = `https://commands.nmultifibra.com.br/maintenance/sms/render_onts_table?tab_id=${tabId}` 
}
...
async function getNumbersToSendSms() {
    ...
    let getContacts = await fetch('https://commands.nmultifibra.com.br/maintenance/sms/get_contacts', requestOptions)
    ...
    return window.location = `https://commands.nmultifibra.com.br/maintenance/sms/render_contacts_page?tab_id=${tabId}` 
}
...
async function createRupture() {
    ...
    const createRuptureRequest = await fetch('https://commands.nmultifibra.com.br/maintenance/sms/create_rupture', requestOptions)
    ...
    return window.location = `https://commands.nmultifibra.com.br/maintenance/sms/render_rupture_page?tab_id=${tabId}` 
}
...
async function sendSms() {
    ...
    const sendSmsRequest = await fetch('https://commands.nmultifibra.com.br/maintenance/sms/send_sms', requestOptions)
    ...
    return window.location = `https://commands.nmultifibra.com.br/maintenance/sms/render_sms_result_page?tab_id=${tabId}` 
}
