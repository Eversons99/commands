...
async function searchOntsSms() {
    ...
    const ontsRequest = await fetch('http://168.0.96.11:50074/maintenance/sms/search_onts', requestOptions)
    ...
    if (responsOfontsRequest.error == true) {
        ...
        return window.location = `http://168.0.96.11:50074/maintenance/sms/render_error_page?message=${messageError}`
    }

    return window.location = `http://168.0.96.11:50074/maintenance/sms/render_onts_table?tab_id=${tabId}` 
}
...
async function getNumbersToSendSms() {
    ...
    let getContacts = await fetch('http://168.0.96.11:50074/maintenance/sms/get_contacts', requestOptions)
    ...
    return window.location = `http://168.0.96.11:50074/maintenance/sms/render_contacts_page?tab_id=${tabId}` 
}
...
async function createRupture() {
    ...
    const createRuptureRequest = await fetch('http://168.0.96.11:50074/maintenance/sms/create_rupture', requestOptions)
    ...
    return window.location = `http://168.0.96.11:50074/maintenance/sms/render_rupture_page?tab_id=${tabId}` 
}
...
async function sendSms() {
    ...
    const sendSmsRequest = await fetch('http://168.0.96.11:50074/maintenance/sms/send_sms', requestOptions)
    ...
    return window.location = `http://168.0.96.11:50074/maintenance/sms/render_sms_result_page?tab_id=${tabId}` 
}
