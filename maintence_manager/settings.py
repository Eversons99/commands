"""
Django settings for maintence_manager project.
...
ROOT_URLCONF = "maintence_manager.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [
            f'{BASE_DIR}/commands_generator/templates/'.replace('\\', '/'),
            f'{BASE_DIR}/atteuations_manager/templates/'.replace('\\', '/')
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "maintence_manager.wsgi.application"
